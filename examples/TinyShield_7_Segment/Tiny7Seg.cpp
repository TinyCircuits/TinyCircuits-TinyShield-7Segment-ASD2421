...
void Tiny7Seg::write(uint8_t regAddr, uint8_t regData)
{
  Wire.beginTransmission(0x20);
  Wire.write(regAddr); 
  Wire.write(regData);
  Wire.endTransmission();
  if(regAddr==0) lastWriteToReg[0]=regData;
  if(regAddr==1) lastWriteToReg[1]=regData;
}

void Tiny7Seg::writeInt(uint8_t digit, uint8_t num)
{
...
void Tiny7Seg::printInt(int num)
{
...
void Tiny7Seg::setDecPoints(uint8_t left, uint8_t right)
{
